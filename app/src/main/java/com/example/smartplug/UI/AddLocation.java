...
public class AddLocation extends Fragment implements LocationListener {
    ...
    public AddLocation() {
        ...
        addLocationButton = (Button) getView().findViewById(R.id.addLocationButton);
            ...
            public void onClick(View v) {
                ...
                alertDialogueBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        path += locationName;
                        myRef = database.getReference(path+"Latitude");
                        myRef.setValue(locationLatitude);
                        myRef = database.getReference(path+"Longitude");
                        myRef.setValue(locationLongitude);
